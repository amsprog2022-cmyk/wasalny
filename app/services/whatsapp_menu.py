...
MENU_ROWS = [
    ...
    {"id": f"{INFO_ID_PREFIX}services", "kind": None,        "info": "services", "title": "للخدمات الاخري 🚚", "description": "سوزوكي، دليفري، تيوتا، سبعه راكب، زفاف"},
...
_INFO_TEXT_ALIASES = {
    "services": [
        ...
        "تيوتا", "تويوتا", "سبعه راكب", "سبع راكب", "٧ راكب", "7 راكب", "زفاف", "فرح",
    ],
...
MENU_BODY = (
    ...
    "٣. للخدمات الاخري (سوزوكي، دليفري، تيوتا، سبعه راكب، زفاف)\n"
    "٤. للاستفسارات\n\n"
    "دوس على الزرار تحت واختار، أو ابعتلنا رقم الخدمة\n"
    "خدمة 24 ساعة في بنها  اهلا بيك في وصلني بنها"
)
